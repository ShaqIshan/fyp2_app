...
import 'package:fyp2_app/Screens/child_screens/games_learning_modules_screen/Modules/basic_skills/Inner_modules/drawing_practice_games/levels_components_shared/star_shapes_level_components/star_path_painter.dart';
import 'package:fyp2_app/Screens/child_screens/games_learning_modules_screen/Modules/basic_skills/Inner_modules/drawing_practice_games/levels_components_shared/star_shapes_level_components/star_shapes_components.dart';
import 'package:fyp2_app/Screens/child_screens/games_learning_modules_screen/Modules/basic_skills/Inner_modules/drawing_practice_games/levels_components_shared/star_shapes_level_components/star_shapes_helpers.dart';
...
class _StarShapesLevelState extends State<StarShapesLevel> {
  ...
  bool hasCompletedTriangle = false;
...
// HACK: currently set 2 drawings and done to go back to everyday basics
//TODO: will change to include other parts of drawing module probably
  void _handleNext() {
    if (currentShape == 'triangle') {
      setState(() {
        hasCompletedTriangle = true;
        currentShape = 'square';
        _resetLevel();
      });
    } else if (currentShape == 'square' && hasCompletedTriangle) {
      // Both shapes are complete, notify game completion
